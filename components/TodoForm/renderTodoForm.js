...
inputTodo.setAttribute ('id', 'todo-input');
...
divLife.setAttribute('id', 'div-sport');
...
buttonSubmitTodo.setAttribute('class', 'todo-form-submit-button');
buttonSubmitTodo.textContent='Add todo';
