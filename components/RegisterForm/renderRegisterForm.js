...
submitButton.setAttribute('class', 'register-submit-button')
...
createUserWithEmailAndPassword(auth, email, password1).then((userCredentials) => {console.log(userCredentials)
renderHomePage()});
} else {
